...
--
-- Database: `anovel_approach_forcredit_cardfrauddetection`
--
CREATE DATABASE IF NOT EXISTS `anovel_approach_forcredit_cardfrauddetection` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `anovel_approach_forcredit_cardfrauddetection`;
...
('aavlzz25duopv6o0u4orx3b02jhmkcvh', 'eyJ1c2VyaWQiOjJ9:1mp8dj:aj5DXPLFBKC9FTuXOGKQ8JA55gPO1AV7IRFiLivyF64', '2021-12-06 12:41:43.953113'),
...
('e7rcaicn1jib70om3jtlk4xdkq3q1lkv', 'eyJ1c2VyaWQiOjJ9:1mp7nm:4BHp4EdXfF2lWj9a0PNopnkMUsK8gmNeHYq8F5je2Ds', '2021-12-06 11:48:02.796980'),
...
('wksnorl9cynkzdgxajlovoxiu9sb7ucm', 'eyJ1c2VyaWQiOjR9:1mp8lH:3FOlybaLE2um-S-2umyUrm4zER4_ln-015EzoEcPNWg', '2021-12-06 12:49:31.848411'),
...
(3, 'Rajesh', 'Rajesh123@gmail.com', 'Rajesh', '9535866270', 'India', 'Karnataka', 'Bangalore'),
(4, 'Ashok', 'Ashok123@gmail.com', 'Ashok', '9535866270', 'India', 'Karnataka', 'Bangalore');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_credit_card_fraud_detection`
--

CREATE TABLE IF NOT EXISTS `remote_user_credit_card_fraud_detection` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fraud_Cases` varchar(30000) NOT NULL,
  `Valid_Transactions` varchar(30000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `remote_user_detection_results`
--

CREATE TABLE IF NOT EXISTS `remote_user_detection_results` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `model_name` varchar(300) NOT NULL,
  `precision1` varchar(300) NOT NULL,
  `recall` varchar(300) NOT NULL,
  `F1_Score` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
